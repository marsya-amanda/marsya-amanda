...
- Systems: POSIX threads, IPC, signals, mutexes
- Logic: Prolog

---

### Experience
- **Data Science Intern (ML-focused)**  
  Model development, experimentation, feature engineering, and evaluation.
- **Data Science Research Mentee**  
  Worked on applied statistical tests on financial markets.
...
If you're working on something interesting in systems, data, or applied AI, feel free to reach out.
